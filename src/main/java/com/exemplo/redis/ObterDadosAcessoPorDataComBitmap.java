...
public class ObterDadosAcessoPorDataComBitmap {
    ...
    public static void main(String[] args) {
        ObterDadosAcessoPorDataComBitmap dadosDeAcesso = new ObterDadosAcessoPorDataComBitmap();
        ...
        System.out.println(String.format("Total de usuários únicos entre os dias %s e %s foi: %d", semanal[0], semanal[6], totalSemanal));
    }
}
