...
public class ConjuntoDeGrupoDePessoas {
    public void adicionaMembrosAoGrupo(String grupo, String[] membros){
        ...
        System.out.println(String.format("Grupo (%s) tem %d membros %s",grupo,resultado,Arrays.toString(membros)));
    }

    public static void main(String[] args) {
        ConjuntoDeGrupoDePessoas relacionamentos = new ConjuntoDeGrupoDePessoas();
